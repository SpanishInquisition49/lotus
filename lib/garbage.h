 ...
 * @param mtx a pthread_mutex_t pointer to the mutex used for the "stop the world"
 * @param cond a pthread_cond_t pointer used by the interpreter to signal the GC when it's safe to run
 */
...
/**
 * Initialize a number value in the lotus language and add it in the GC values list
